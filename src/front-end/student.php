        ...
        <div class="wrapper">
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled components">
                    ...
                    <li>
                      ...
                      function showClassSchedule(ogrenci_url) {
                        ...
                        <ul class="collapse list-unstyled" id="pageSubmenu">
                            ...
                            <li>
                              <a href="#Klüplerim" onclick="showKlup(<?php echo $current_ogrenciId; ?>)">Klüplerim</a>
                              <script>
                              function showKlup(ogrenci_url) {
                                ...
                                xmlhttp.open("GET","student_klup.php?q="+ogrenci_url,true);
                                xmlhttp.send();
                              }
                              </script>
                    ...
                    <li>
                      <a href="#NotDokumu" onclick="showGrades(<?php echo $current_ogrenciId; ?>)">Not Dökümüm</a>
                      <script>
                      function showGrades(ogrenci_url) {
                        ...
                        xmlhttp.open("GET","student_grades.php?q="+ogrenci_url,true);
                        xmlhttp.send();
                      }
                      </script>
                    </li>
